          ...
          <form id="projects-filter">
            <div class="ProjectsContentFilter__title">
             ...
             <div class="ProjectsContentFilter__inputs">
              ...
              <label class="Input">
                <span class="Input__label">Bathrooms</span>
                <div class="Input__content">
                  <div class="Input__content_icon">
              ...
              <label class="Input">
                <span class="Input__label">Bedrooms</span>
                <div class="Input__content">
                  <div class="Input__content_icon">
              ...
              <label class="Input">
                <span class="Input__label">Garages</span>
                <div class="Input__content">
                  <div class="Input__content_icon">
              ...
              <label class="Input">
                <span class="Input__label">Min</span>
                <div class="Input__content">
                  <div class="Input__content_icon">
                    <p>R$</p>
                  </div>
              ...
              <label class="Input">
                <span class="Input__label">Max</span>
                <div class="Input__content">
                  <div class="Input__content_icon">
                    <p>R$</p>
                  </div>
          ...
          <label class="Input">
            ...
            <div class="Input__content">
              <div class="Input__content_input Input__content_input--padding-x-max">
                <input type="text" placeholder="Ex: General Construction">
              </div>
              <button class="Input__content_icon Input__content_icon--border-right Input__content_icon--button">
          ...
          <a href="<?= BASE ?>projetos/produto/general-construction" class="Project">
            <div class="Project__image">
              ...
              <div class="Project__image_price">
                <p><strike>R$124,00</strike> R$ 111,60</p>
              </div>
            </div>
            ...
            <div class="Project__info">
              ...
              <div class="Project__info_text">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, neque id.</p>
              </div>
