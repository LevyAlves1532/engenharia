...
<html lang="en">
  ...
  <body>
    ...
    <main class="WrapperSignIn">
      <div class="WrapperSignIn__container container-md d-flex justify-content-center align-items-center">
        <div class="SignInBox">
          <div class="SignInBox__logo d-flex justify-content-center mb-3">
            <a href="<?= BASE ?>" class="d-flex align-items-center">
              <img src="https://www.semesb.com.br/wp-content/uploads/2019/10/cropped-logo-fundo-transparente.png" width="50" alt="">
              <p>Engenharia</p>
            </a>
          </div>

          <div class="SignInBox__title text-center mb-3">
            <h1>Fazer Login</h1>
          </div>
