            ...
            <form id="form-checkout">
              ...
              <div class="InputDouble">
                <label class="Input">
                  ...
                  <div class="Input__content">
                    ...
                    <div class="Input__content_input">
                      <input type="text" name="cardExpirationYear"  id="form-checkout__expirationDate" placeholder="MM/YY">
                    </div>
                  </div>
                ...
                <label class="Input">
                  ...
                  <div class="Input__content">
                    ...
                    <div class="Input__content_input">
                      <input type="text" name="cardSecurityCode"  id="form-checkout__securityCode" placeholder="Digite o código de segurança...">
                    </div>
                  </div>
              ...
              <label class="Input">
                ...
                <div class="Input__content">
                  ...
                  <div class="Input__content_input">
                    <input type="text" name="cardholderName"  id="form-checkout__cardholderName" placeholder="Digite o seu nome...">
                  </div>
                </div>
              ...
              <div class="InputDouble">
                <label class="Input">
                  ...
                  <div class="Input__content">
                    ...
                    <div class="Input__content_input">
                      <input type="text" name="identificationNumber" id="form-checkout__identificationNumber" placeholder="Digite seu CPF/CNPJ..." />
                    </div>
                  </div>
                ...
                <label class="Input">
                  ...
                  <div class="Input__content">
                    ...
                    <div class="Input__content_input">
                      <input type="text" name="cardholderEmail" id="form-checkout__cardholderEmail" placeholder="Digite seu e-mail..." />
                    </div>
                  </div>
