<footer class="Footer">
  <div class="Footer__container">
    <div class="Footer__container_content">
      <div class="FooterApresentation">
        <div class="FooterApresentation__logo">
          <a href="<?= BASE ?>">
      ...
      <div class="FooterLinks">
        <div class="FooterLinks__title">
          <p>Pages</p>
        </div>

        <div class="FooterLinks__list">
          <ul>
      ...
      <div class="FooterSocial">
        ...
        <div class="FooterSocial__button">
          <a href="https://www.facebook.com/" target="_blank" aria-label="Perfil do site no facebook">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M80 299.3V512H196V299.3h86.5l18-97.8H196V166.9c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4 .4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8H80z"/></svg>
          </a>
          <a href="https://www.instagram.com/" target="_blank" aria-label="Perfil do site no instagram">
          ...
          <a href="https://www.threads.net/?hl=pt-br" target="_blank" aria-label="Perfil do site no threads">
