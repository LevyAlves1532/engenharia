    ...
    <div class="Header__bar_container">
      ...
      <div class="HeaderOptions">
        ...
        <ul class="HeaderOptions__buttons">
          <li><a href="<?= BASE ?>conta">Fazer Login</a></li>
          <li>
              ...
              <div class="HeaderCart__content">
                ...
                <div class="HeaderCart__content_info">
                  ...
                  <div class="HeaderCartButton">
                    <a href="<?= BASE ?>carrinho" class="Button">Go to the Cart</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="Header__content">
    <div class="Header__content_container">
      ...
      <div class="HeaderMenu">
        <button class="HeaderMenu__button" id="button-menu">
          <div></div>
          <div></div>
          <div></div>
        </button>
