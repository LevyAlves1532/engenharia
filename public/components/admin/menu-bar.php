<div class="AdmMenuBar">
  <div class="AdmMenuBar__container">
    <div class="AdmMenuBar__container_logo mb-5">
    ...
    <div class="AdmMenuBar__container_nav">
      <nav>
        <ul>
          <li class="nav-item">
          ...
          <li>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#control" aria-expanded="true" aria-controls="control">
                  Controle
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                </button>
              </h2>
              <div id="control" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                <ul>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/projects">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/users">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/team">
          ...
          <li>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#financial" aria-expanded="true" aria-controls="financial">
                  Financeiro
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                </button>
              </h2>
              <div id="financial" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                <ul>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/payments">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/reimbursement">
          ...
          <li>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#social" aria-expanded="true" aria-controls="social">
                  Social
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                </button>
              </h2>
              <div id="social" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                <ul>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/feedbacks">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/posts_instagram">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?= BASE ?>admin/faq">
